...
namespace Rainbow.ImgLib.Formats.Serializers
{
    public interface TextureFormatSerializer
    {
        ...
        /// <summary>
        /// Exports a texture of the format implemented by this TextureFormatSerializer and the texture's metadata (if any) 
        /// into the given stream and directory. Image data files' are constructed starting from a base name.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a texture of the format implemented by this TextureFormatSerializer from a given metadata stream and a directory containing image data.
        /// </summary>
        /// <param name="metadata"></param>
        /// <param name="directory"></param>
