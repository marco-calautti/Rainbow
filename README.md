...
Note for multi clut TIM2 images. When dealing with single clut TIM2 files, Rainbow will take care of everything for you by applying quantization to the given png, in order to keep te number of used colors under the maximum allowed by the original TIM2.
